...
export default function Join() {
    const membershipTypes: MembershipType[] = [
        ...
        },
        {
            name: "Junior",
            price: "£1",
            requirements: "Aged 12 but under 17 with a Parent or Guardian who is a FULL member",
        ...
        },
        {
            name: "Child",
            price: "£1",
            requirements: "Aged 0 to 11 with a Parent or Guardian who is a full member",
            competes: MembershipRight.Yes,
            newsletter: MembershipRight.No,
    ...
    return (
        <main>
            ...
            <p className="mb-2">
                ...
                regulations. There will be scrutineers you will be able to check 
                this for you.
            </p>

            <p className="mb-2">
                There are many types of memberships available, all of which last for
                a year. See below for the different types that are available.
            </p>
                ...
                <table className="table-auto border-gray w-full min-w-[768px] bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden">
                    <thead className="bg-gray-200 dark:bg-gray-600">
                        <tr className="border-b border-grey-700">
                            ...
                            <th className="px-2 py-2" colSpan={4}>Membership Benefits</th>
                        </tr>
                        <tr className="border-b border-grey-700">
            ...
            <p className="mb-2">
                If you would like to join, you can fill out our online membership 
                form below.
            </p>
            <p className="mb-2">
                Alternatively, you can print out a paper membership form and mail it to us:
            </p>
